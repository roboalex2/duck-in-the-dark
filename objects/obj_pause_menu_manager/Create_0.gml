is_paused = false;
menu_state = "main"; // NEU: Merkt sich, in welchem Menü wir sind ("main" oder "credits")
button_array = [];
current_index = 0;
...
spawn_main_buttons = function() {
    ...
    button_array[0].button_action = function() { 
        with(obj_pause_menu_manager) { spawn_credits_buttons(); } // Wechselt zum Entwickler-Screen!
    };
