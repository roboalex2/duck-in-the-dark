...
var _p_x = margin;
var _p_y = _gui_h - box_height * 2 + margin ;
if (portrait_sprite != noone) {
    ...
    draw_sprite_ext(portrait_sprite, (current_time / 100) % sprite_get_number(portrait_sprite), margin, _p_y + (box_height/2), _scale, _scale, 0, c_white, 1);
}
